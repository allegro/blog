...
When performing a code review on a pull request modifying a blog post, follow the instructions listed below in the "Checking a blog post" paragraph.
Apply these checks to all blog posts (`*.md` files) modified in the pull request.
