...
![on-heap vs off-heap](/assets/img/articles/2022-06-30-gc-hands-off-my-data/compare.png)
...
![on-heap GC chart](/assets/img/articles/2022-06-30-gc-hands-off-my-data/on-heap-small-gc.png)

*The GC profile of off-heap variant:*
![on-heap GC chart](/assets/img/articles/2022-06-30-gc-hands-off-my-data/off-heap-small-gc.png)
...
*The GC profile of on-heap variant:*
![on-heap GC chart](/assets/img/articles/2022-06-30-gc-hands-off-my-data/on-heap-gc.png)
Memory usage increases throughout the test, there are 40 GC collection cycles that together last 0.212s.

*The GC profile of off-heap variant:*
![on-heap GC chart](/assets/img/articles/2022-06-30-gc-hands-off-my-data/off-heap-gc.png)
...
![on-heap GC chart](/assets/img/articles/2022-06-30-gc-hands-off-my-data/on-heap-jmeter.png)

*jMeter metrics of off-heap variant:*
![on-heap GC chart](/assets/img/articles/2022-06-30-gc-hands-off-my-data/off-heap-jmeter.png)
