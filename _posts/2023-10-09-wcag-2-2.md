...
Web Contents Accessibility Guidelines, is kind of like a set of rules to make sure Internet is like a bar that everyone can enjoy.
...
I think we all can agree here - it is just annoying if you are browsing the web and all of a sudden something appears - a modal, cookie banner, chat
...
This comes along with criterion 2.5.5 introduced in WCAG 2.1 ([minimum target size](https://www.w3.org/WAI/WCAG21/Understanding/target-size.html)) - this is if
...
solving puzzles. This requirement will help people with cognitive disabilities including memory, dyslexia, dyscalculia… but of course not only (check these [captcha struggles fails](https://www.boredpanda.com/captcha-struggles-fails/)).
