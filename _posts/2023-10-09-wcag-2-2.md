...
This comes along with criterion 2.5.5 introduced in WCAG 2.1 ([minimum target size](https://www.w3.org/WAI/WCAG21/Understanding/target-size.html)) - this is of
