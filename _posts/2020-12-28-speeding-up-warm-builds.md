...
![Run script: For install builds only - checkbox in Xcode](/assets/img/articles/2020-12-28-speeding-up-warm-builds/xcode-run-for-release.png)
...
![Run script: Based on dependency analysis - checkbox in Xcode](/assets/img/articles/2020-12-28-speeding-up-warm-builds/xcode-dependency-analysis.png)
...
![Allegro iOS - graph depicting Warm Build Time change over months](/assets/img/articles/2020-12-28-speeding-up-warm-builds/warm-build-graph.png)
