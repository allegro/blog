...
<img width=1000 src="/img/articles/2024-06-06-the-noisy-hit-compiler/response_time_spike_no_scale.png"/>
...
<img width=1000 src="/img/articles/2024-06-06-the-noisy-hit-compiler/cpu_spike.png"/>
...
<img width=1000 src="/img/articles/2024-06-06-the-noisy-hit-compiler/flamegraph-c2.png"/>

## What is Jit compiler?
What actually is Just-In-Time(JIT) compiler?
Java Virtual Machine collects statistics at runtime of how many times given code was executed. When is exceeds threshold, it will recompile code
(typically bytecode or kind of VM instructions) into native instruction set optimized for given CPU. It can have major impact on application performance,
at a price of recompilation time. JIT compiler consists of two major groups, so called C1 & C2 compiler threads. Those comes from old days when we differentiate between client and server
...
<img width=1000 src="/img/articles/2024-06-06-the-noisy-hit-compiler/jit_threads.png"/>
...
<img width=1000 src="/img/articles/2024-06-06-the-noisy-hit-compiler/c2-threads.png"/>
...
5. Two C2 threads works 100% to recompile code as pointed by JVM.
...
<img width=1000 src="/img/articles/2024-06-06-the-noisy-hit-compiler/8x_C2.png"/>
...
<img width=1000 src="/img/articles/2024-06-06-the-noisy-hit-compiler/cpu_after.png"/>
But finally our SLA is healthy, restarts are completely transparent!
<img width=1000 src="/img/articles/2024-06-06-the-noisy-hit-compiler/sla_after.png"/>
