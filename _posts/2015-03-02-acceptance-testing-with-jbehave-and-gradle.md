...
must pay when we list an offer in [allegro.pl](https://allegro.tech). Complete source code is available on
...
![](/assets/img/articles/2015-03-02-acceptance-testing-with-jbehave-and-gradle/jbehave-reports.png)

We can click on the test name to see its details.

![](/assets/img/articles/2015-03-02-acceptance-testing-with-jbehave-and-gradle/jbehave-root-category.png)
